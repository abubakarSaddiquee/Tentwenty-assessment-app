...
export default function TaskModal({
  ...
  const {
    ...
    defaultValues: { project: "", typeOfWork: "", taskDescription: "", hours: 4 },
  });
  ...
  useEffect(() => {
    if (editingTask) {
      reset({
        ...
        hours: editingTask.hours || 4,
      });
    } else {
      reset({ project: "", typeOfWork: "", taskDescription: "", hours: 4 });
    }
      ...
      <form onSubmit={handleSubmit(handleFormSubmit)} noValidate className="flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <div className="flex items-center w-28">
            ...
            <button
              type="button"
              onClick={() => setValue("hours", Math.min(24, (hours || 0) + 1))}
